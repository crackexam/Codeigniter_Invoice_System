...
class Login_model extends CI_Model
{
    ...
    function checkActivationDetails($email, $activation_id)
    {
        ...
        $query = $this->db->get();*/
		$query = $this->db->query("SELECT * FROM tbl_reset_password WHERE activation_id = '$activation_id'");
		return $query->num_rows;
		
    }
	function checkActivationcode($email, $activation_id){
		//$query = $this->db->select('select * from tbl_reset_password where activation_id = "$activation_id"');
		//return $query->num_rows;
		$query = $this->db->select('id')->from('tbl_reset_password')->where('activation_id', $activation_id)->get();
		return $query->row('id');
	}
