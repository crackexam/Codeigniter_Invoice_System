...
class Company_model extends CI_Model
{
     ...
     */
    function checkCompanyExists($name,$company_email)
    {
        $this->db->select('*');
        $this->db->from("tbl_company");
        $this->db->where("company_name", $name,"company_email",$company_email);   
     ...
     * @param number $userId : This is user id
     */
    function updateCompanyDetails($companyInfo, $company_id)
    {
        $this->db->where('company_id', $company_id);
