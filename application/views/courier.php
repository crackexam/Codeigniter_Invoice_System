        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url('shipping'); ?>/courierAdd"><i class="fa fa-plus"></i> Add New Courier</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">All Courier List</h3>
                    <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover" id="myTable">
                    ...
                    <?php
                    if(!empty($courierRecords))
                    {
                        foreach($courierRecords as $record)
                        {
                    ?>
                    <tr>
                      <td><?php echo $record->courier_id ?></td>
                      ...
                      <td class="text-center">
                          ...
                          <a class="btn btn-sm btn-info" href="<?php echo base_url('shipping').'/editCourier/'.$record->courier_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a> <!--<strong>|</strong>
