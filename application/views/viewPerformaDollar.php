				...
				<div class="box box-primary" id="pdfcret">
							<div class="col-xs-12 text-right" style="margin-top:1%">
								<div class="form-group">
									<a class="btn btn-primary" href="<?php echo base_url().'viewPerforma/'.$invoice_id; ?>">View Performa In <i class="fa fa-inr"></i></a>
								</div>
							</div>
							 ...
							 <table id="invoiceTable" width="100%" border="1"  >
								  ...
								  <tbody>
									...
									?>
								  	<tr style="text-align:center!important;">
										...
										<td><?php echo currencyConverter($record->product_price); ?></td>
										<td><?php echo $record->product_qty ?></td>
										<td><?php echo $record->product_gst ?> %</td>
										<td><?php echo currencyConverter($record->pro_cal_gst_amount); ?></td>
										<td><?php echo $record->pro_disc_rate ?></td>
										<td><?php echo currencyConverter($record->pro_disc_amount); ?></td>
										<td><?php echo currencyConverter($record->amount); ?></td>
										<td ><?php echo currencyConverter($record->net_payable_product_amount); ?></td>
									</tr>
									<?php
										$i++;}
									}
								  ...
								  <tfoot>
								    <tr>
									 ...
									 <td style="text-align:center!important;"><?php echo currencyConverter($shipping_cost);?></td>
									<tr> 
									<tr>
									 ...
									 <td style="text-align:center!important;margin-right:5%"><strong ><?php echo $shipptax =currencyConverter(($shipping_cost*$maxgst)/100);?></strong></td>
									<tr>
									<?php
										if($amount_paid>0){
									?>
									...
									<td style="text-align:center!important;"><strong>Total</strong></td>
									 <td colspan="7" style="text-align:right!important;">Amount Chargable <Strong style="font-size:14px;margin-right:5%"><?php
									 
									$totalamount=($invoice_subtotal+($shipping_cost*$maxgst)/100)-$amount_paid;
									 //echo convertToIndianCurrency(currencyConverter($totalamount)); ?>
									 </Strong></td>
									 <td colspan="2" style="text-align:center!important; font-size:20px;"><i class="fa fa-usd"></i>&nbsp;&nbsp;&nbsp;<strong><?php echo currencyConverter($totalamount);?></strong></td>
									<tr>
								  </tfoot>
								</table> 
							    ...
							    <?php if($m_client_state != "delhi" AND $m_client_state != "Delhi"){?>
								  ...
								  <tfoot>
									...
									<td><strong><?php echo currencyConverter($total_without_gst);?></strong></td>
									<td><strong><?php echo currencyConverter($gst_tax_total);?></strong></td>
									<td><i class="fa fa-usd"></i>&nbsp;&nbsp;&nbsp;<strong><?php echo currencyConverter($gst_tax_total);?></strong></td>
									</tr>
								    <!--<tr>
								...
								<?php }else {?>
									...
									?>
								  	<tr>
										...
										<td><?php echo currencyConverter(($record->pro_cal_gst_amount)/2); ?></td>
										<td><?php echo ($record->product_gst)/2; ?> %</td>
										<td><?php echo currencyConverter(($record->pro_cal_gst_amount)/2); ?></td>
										<td><?php echo currencyConverter($record->pro_cal_gst_amount); ?></td>
									</tr>
									...
									<tr style="text-align:center!important;">
									<td><strong>Total</strong></td>
									<td><strong><?php echo currencyConverter($total_without_gst);?></strong></td><td></td>
									<td><strong><?php echo round(currencyConverter($gst_tax_total/2,2));?></strong></td><td></td>
									<td><strong><?php echo round(currencyConverter($gst_tax_total/2,2));?></td>
									<td><i class="fa fa-usd"></i>&nbsp;&nbsp;&nbsp;<strong><?php echo currencyConverter($gst_tax_total)?></strong></td>
									</tr>
								    <!--<tr>
...
function currencyConverter($amount) {	
	...
	$convertedAmount = $amount/number_format($exhangeRate,2);
