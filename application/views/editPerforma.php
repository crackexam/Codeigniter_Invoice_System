            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>updatePerforma" method="post" id="updateInvoice" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
								 ...
								 <div class="col-md-2">
									...
									<label for="email">Select Cuurency Type</label>
                                       <select class="form-control " id="currency_type" name="currency_type">
											<option value="INR" <?php if($currency_type=="INR") echo 'selected="selected"'; ?>>Indian Rupee</option>
											<option value="USD" <?php if($currency_type=="USD") echo 'selected="selected"'; ?>> US Dollar</option>
									   </select>
                                    </div>
								 </div>
								<div class="col-md-12">
									...
									<label for="email">Special Msg</label>
                                       <input type="text" name="spl_msg" class="form-control" value="<?php echo $spl_msg;?>">
                                    </div>
								  ...
								  <tbody>
									...
									?>
								  	<tr>
										...
										<td><input type="text" data-type="productCode" name="price[]" id="price_<?php echo $i;?>" class="form-control  "  value="<?php echo $record->product_price ?>"></td>
										<td><input type="text" name="quantity[]" id="quantity_<?php echo $i;?>" class="form-control changesNo" autocomplete="off"  ondrop="return false;" onpaste="return false;" value="<?php echo $record->product_qty ?>"></td>
										<td><input type="text" data-type="taxAmount" name="tax[]" id="tax_<?php echo $i;?>" class="form-control tax"  value="<?php echo $record->product_gst ?>" ></td>
										<td><input type="text" name="taxAmount[]" id="taxAmount_<?php echo $i;?>" class="form-control " autocomplete="off"  value="<?php echo $record->pro_cal_gst_amount ?>" disabled>
										<input type="hidden" name="taxAmounthd[]" id="taxAmounthd_<?php echo $i;?>" class="form-control " autocomplete="off"  value="<?php echo $record->pro_cal_gst_amount ?>" ></td>
										<td><input type="text" name="discount[]" id="discount_<?php echo $i;?>" class="form-control discount" autocomplete="off"  ondrop="return false;" value="<?php echo $record->pro_disc_rate ?>" onpaste="return false;"></td>
										<td><input type="text" name="discountamount[]" id="discountAmount_<?php echo $i;?>" class="form-control discountam"  autocomplete="off"  ondrop="return false;" onpaste="return false;" value="<?php echo $record->pro_disc_amount ?>">
										<input type="hidden" name="discountamounthd[]" id="discountAmounthd_<?php echo $i;?>" class="form-control discount"  autocomplete="off"  ondrop="return false;" onpaste="return false;"value="<?php echo $record->pro_disc_amount ?>"></td>
										<td><input type="text" name="total[]" id="total_<?php echo $i;?>" class="form-control" autocomplete="off"  ondrop="return false;" onpaste="return false;" value="<?php echo $record->amount ?>" disabled>
										<input type="hidden" name="totalhd[]" id="totalhd_<?php echo $i;?>" class="form-control" autocomplete="off"  ondrop="return false;" onpaste="return false;" value="<?php echo $record->amount ?>"></td>
										<td><input type="text" name="product_payable[]" id="product_payable_<?php echo $i;?>" class="form-control totalLinePrice" autocomplete="off"  ondrop="return false;" onpaste="return false;" disabled value="<?php echo $record->net_payable_product_amount ?>"><input type="hidden" name="product_payablehd[]" id="product_payablehd_<?php echo $i;?>" class="form-control " autocomplete="off"  ondrop="return false;" onpaste="return false;" value="<?php echo $record->net_payable_product_amount ?>" ></td>
									</tr>
									<?php
										$i++;}
									}
						...
						<div class='col-md-9'>
							<div class="form-group col-md-2">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control shipping_cost" name="shipping_cost" id="shipping_cost" value="<?php echo $shipping_cost?>"  ondrop="return false;" onpaste="return false;" >
								</div>
							</div>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-2">
								...
								<div class="input-group">
									<div class="input-group-addon"><i class="fa fa-inr"></i></div>
									<input type="text" class="form-control" name="invoice_subtotal" id="subTotal" placeholder="Subtotal"  ondrop="return false;" onpaste="return false;" value="<?php echo $invoice_subtotal?>">
								</div>
							</div>
							...
							<div class="form-group col-md-2">
								...
								<div class="input-group">
									<div class="input-group-addon"><i class="fa fa-inr"></i></div>
									<input type="text" class="form-control" name="amount_paid" id="amountPaid" placeholder="Amount Paid"  ondrop="return false;" onpaste="return false;" value="<?php echo $amount_paid?>">
								</div>
							</div>
							<div class="form-group col-md-2">
								...
								<div class="input-group">
									<div class="input-group-addon"><i class="fa fa-inr"></i></div>
									<input type="text" class="form-control amountDue" name="amount_due" id="amountDue" placeholder="Amount Due"  ondrop="return false;" onpaste="return false;" value="<?php echo $amount_due?>">
								</div>
							</div>
...
$("#addmore").on('click',function(){
	...
	html81 = '<td><input type="text" name="discountamount[]" id="discountAmount_'+i+'" class="discountam form-control " autocomplete="off" ><input type="hidden" name="discountamounthd[]" id="discountAmounthd_'+i+'" class="discount form-control " autocomplete="off"></td>';
...
$(document).on('change blur','.discountam',function(){
	id_arr = $(this).attr('id');
	id = id_arr.split("_");
	var discount = $('#discountAmount_'+id[1]).val();
	//alert(discount);
	var gst_amount = $('#taxAmount_'+id[1]).val();
	//alert(gst_amount);
	var total_line_amount=$('#total_'+id[1]).val();
	//alert(total_line_amount);
	var discount_rate = (discount*100)/total_line_amount;
	$('#discount_'+id[1]).val( discount_rate.toFixed(2));
	//$('#discountAmounthd_'+id[1]).val( discount_amount.toFixed(2) );
