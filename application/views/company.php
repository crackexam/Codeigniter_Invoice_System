<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-home"></i> Company Management
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addCompany"><i class="fa fa-plus"></i> Add New Company</a>
                </div>
            </div>
        </div>
        <div class="row">
                  ...
                  <table class="table table-hover" id="myTable">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                          ...
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'editCompany/'.$record->company_id; ?>" title="Edit"><i class="fa fa-pencil"></i></a> <!--<strong>|</strong>
