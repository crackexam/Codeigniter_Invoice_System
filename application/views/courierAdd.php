<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Courier Management
        <small>Add Courier</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
               <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url('shipping') ?>/addNewCourier" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="courier_name" name="courier_name" maxlength="11">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
