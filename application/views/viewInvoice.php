							...
							<form class="form" style="padding:2%">
									<table border="1" width="100%">
									  <tr>
										...
										<td colspan="4" align="center"><label>Invoice No.:-</label> <strong> <?php echo $invoice_number?></strong></td>
									  ...
									  <tr>
										<td colspan="2" rowspan="3" >
											...
											<label style="margin-left:2%;"></label><?php echo $client_address?><br><?php if($client_pincode != "N/A"){?><label style="margin-left:2%;">Pincode:</label> <?php echo $client_pincode?><br/><?php }?>
											<?php if($state_name != ""){?><label style="margin-left:2%;">State:</label> <?php echo $state_name?><br/><?php }?>
							 ...
							 <table id="invoiceTable" width="100%" border="1"  >
								  ...
								  <tbody>
									...
									?>
								  	<tr style="text-align:center!important;">
										<td><?php echo $i;?></td>
										<td><?php echo $record->product_name ?> (<?php echo $record->product_hsn ?>)</td>
										<td><?php echo $record->product_price ?></td>
										<td><?php echo $record->product_quantity ?></td>
										<td><?php echo $record->product_gst ?> %</td>
										<td><?php echo $record->gst_tax_amount ?></td>
										<td><?php echo $record->discount_rate ?></td>
										<td><?php echo $record->discount_amount ?></td>
										<td><?php echo $record->pro_total_amount ?></td>
								  ...
								  <tfoot>
									...
									$totalamount=$invoice_subtotal+$shipptax;
									 echo convertToIndianCurrency($totalamount); ?></Strong></td>
									 <td colspan="2" style="text-align:center!important; font-size:20px;"><i class="fa fa-inr"></i>&nbsp;&nbsp;&nbsp;<strong><?php echo number_format($totalamount,2);?></strong></td>
									<tr>
								  </tfoot>
								</table> 
								<table width="100%" border="1" >
							    <?php if($state_name != "delhi" AND $state_name != "Delhi"){?>
							        <thead>
									<tr align="center">
										<th >HSN/SAC</th>
										<th >Taxable Value</th>
								...
								<?php }else {?>
									...
									?>
								  	<tr>
										...
										<td><?php echo round(($record->gst_tax_amount)/2,2); ?></td>
										<td><?php echo ($record->product_gst)/2; ?> %</td>
										<td><?php echo round(($record->gst_tax_amount)/2,2); ?></td>
										<td><?php echo $record->gst_tax_amount ?></td>
									</tr>
